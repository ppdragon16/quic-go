...
//
//	mockgen -typed -package quic -self_package github.com/daeuniverse/quic-go -self_package github.com/daeuniverse/quic-go -destination mock_packetconn_test.go net PacketConn
//
